...
const MultiCard1 = () => {
  return (
    <div className="w-[266px] overflow-hidden hover:shadow-md h-[266px] bg-white mt-4 rounded-lg">
      <div className="mt-6">
        <span className="ml-7">01.</span>
        <span>
          <img src="/images/range1.png" alt="card" className="ml-7 mt-2" />
        </span>
        <div className="px-6 py-4">
          <div className="font-bold text-2xl mb-2">Problem</div>
